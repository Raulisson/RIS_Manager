											...
											<div class="form-group col-md-6 campo-grupo">
												...
												<?php else : ?>
													<select name="perfil" id="perfil" class="form-control" required autocomplete="off">
														<option value="1" <?= (isset($usuario['perfil']) && $usuario['perfil'] == "1") ? 'selected' : '' ?>>Administrador</option>
														<option value="2" <?= (isset($usuario['perfil']) && $usuario['perfil'] == "2") ? 'selected' : '' ?>>Técnico</option>
														<option value="3" <?= (isset($usuario['perfil']) && $usuario['perfil'] == "3") ? 'selected' : '' ?>>Vendedor</option>
													</select>
												<?php endif; ?>
											</div>
