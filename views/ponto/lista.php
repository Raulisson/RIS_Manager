					...
					<table class="table datatable">
						<thead>
							<tr class="ul-widget6__tr--sticky-th">
								...
								<th scope="col">
									<?php echo $this->pagination->column("acoes", "Ações") ?>
								</th>
							</tr>
						</thead>
						<tbody>
							...
							foreach ($this->pagination->rows as $pontos) {
								echo "<tr>";
									...
									<a class='text-16 mt-2 font-weight-bold' href='index.php?controle=ponto&acao=form&id={$pontos['id']}'>Informações</a>";
                                    echo "<td class='text-right pr-5'>
									<a class='text-16 mt-2 font-weight-bold' href='index.php?controle=ponto&acao=form&id={$pontos['id']}'>Editar</a>";
                                    if ($usuario['perfil'] = "1") {
